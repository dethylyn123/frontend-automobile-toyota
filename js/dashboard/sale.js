...
async function getData(url = "", keyword = "") {
  ...
  const response = await fetch(
    backendURL + "/api/sale" + queryParams,
    {
      headers: {
...
//   console.log('Form data:', formData); // Add this line
  ...
  // For Update
    ...
    response = await fetch(
      backendURL + "/api/sale/" + for_update_id,
      {
  ...
  document.querySelector("#form_sales button[type='submit']").innerHTML = "Submit";
};
...
if (response.ok) {
    ...
    document.querySelector("#form_sales button[type='submit']").innerHTML = "Update Info";
