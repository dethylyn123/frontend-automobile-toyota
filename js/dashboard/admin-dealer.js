                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="#" id="btn_edit" data-id="${element.dealer_id}">Edit</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#" id="btn_delete" data-id="${element.dealer_id}">Delete</a>
                                    </li>
                                </ul>
                            </div>

                            <div>
                            <h6 class="card-title"><b>Dealer:</b>     ${element.dealer_name}</h5>
                            <h6 class="card-text"><b>Area:</b>     ${element.area}</h6>
...
if (response.ok) {
    ...
    document.getElementById("dealer_name").value = json.dealer_name;
    ...
    document.getElementById("manufacturer_id").value = json.manufacturer_id;
